"""Run matched native Eleusis episodes with retained SystemOne call traces."""
...
def main() -> None:
    ...
    parser.add_argument("--test-every", type=int, default=3)
    parser.add_argument(
        "--arms",
        nargs="+",
        choices=["baseline", "freerider", "jev", "haiku", "mixed"],
                ...
                try:
                    ...
                    for seat in range(5):
                        ...
                        player_env.update(
                            ...
                            else {"PLAYER_SCRIPTED": "freerider"}
