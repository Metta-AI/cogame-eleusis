...
switch(
  "passL",
  (&"""
  -o {distDir / "eleusis_replay.js"}
  -O2
  -s ALLOW_MEMORY_GROWTH
  -s ABORTING_MALLOC=1
  -s ENVIRONMENT=web
  -s MODULARIZE=1
  -s EXPORT_NAME=EleusisReplayModule
  -s EXPORTED_RUNTIME_METHODS=HEAPU8
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_el_load_replay,_el_payload_ptr,_el_payload_len,_el_error_ptr,_el_error_len
  """).replace("\n", " ")
)
